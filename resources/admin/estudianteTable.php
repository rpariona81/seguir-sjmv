        ...
        <div class="card border shadow-xs mb-4">
                    ...
                    <div class="col-md-8 col-lg-8 mx-auto">
                        <div class="mb-3">
                            <div class="input-group mb-3">
                                ...
                                <?= form_dropdown('career_id', $career, $selectValue, 'class="form-control" id="career_id" required'); ?>
                                <button class="btn btn-warning pull-right font-weight-medium mb-0" type="submit">
                                    <!--<i class="ti-search"></i>-->
                                ...
                                &nbsp;
                                <a class="btn waves-effect waves-light btn-success pull-right hidden-sm-down" data-toggle="tooltip" data-placement="bottom" title="Crear nuevo registro" href="<?= base_url('/admin/newegresado') ?>">Nuevo usuario&nbsp;&nbsp;<i class="fa fa-plus"></i></a>
            ...
            <div class="card-body">
                <div class="table-responsive p-0">
                    ...
                    <table id="datatable-buttons" name="datatablesSimple" class="table table-striped nowrap dataTable no-footer dtr-inline" style="width:100%">
                        <thead>
                            <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            if ($item->status) {
                                                ...
                                                echo form_open('admin/desactivaUsuario');
                                                echo '<input type="hidden" id="id" name="id" value="' . $item->id . '">';
                                                ...
                                                echo form_open('admin/activaUsuario');
                                                echo '<input type="hidden" id="id" name="id" value="' . $item->id . '">';
                                            ...
                                            ?>
                                            &nbsp;&nbsp;
                                            <a class="btn btn-outline-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="left" title="Editar" href="<?= base_url('/admin/egresado/' . $item->id) ?>"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
