<div class="align-items-md-stretch mt-5">
    <div class="card">
        <div class="card-header bg-light">
            <h4 class="card-title text-dark">Nuevo usuario</h4>
        </div>
        <?= my_validation_errors(validation_errors()); ?>
        <div class="card-body">
            <?= form_open('admincontroller/creaEgresado', array('class' => 'row g-3 needs-validation')); ?>
            ...
            <div class="col-md-4">
                ...
                <?=form_dropdown('career_id', $career, set_value('career_id'), 'class="form-control" id="career_id" required'); ?>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2">
                ...
                <?=form_dropdown('graduated', $condEstud, 'Egresado', 'class="form-control" id="graduated" disabled'); ?>
            </div>
            ...
            <div class="col-12 mt-2">
                <div class="float-end">
                    <a href="<?=base_url('/admin/users')?>" class="btn btn-danger" type="button">Cancelar</a>
