    ...
    <div class="card-header bg-light">
        ...
        <div class="card-body">
            ...
            <div class="col-md-4">
                ...
                <?=form_dropdown('career_id', $career, $usuario->career_id, 'class="form-control" id="career_id" required'); ?>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2">
                ...
                <?=form_dropdown('graduated', $condEstud, $usuario->graduated, 'class="form-control" id="graduated" disabled'); ?>
            </div>
            <div class="col-md-4">
